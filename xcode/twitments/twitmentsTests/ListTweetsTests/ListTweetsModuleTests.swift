...
class ListTweetsModuleTests: XCTestCase {

	// MARK: - Variables

	var module: ListTweetsModule?
	...
	override func setUp() {
        ...
        let viewModels = mockTestViewModels()
        XCTAssertNotNil(viewModels)
		module = ListTweetsModule(viewModels: viewModels)
	}
