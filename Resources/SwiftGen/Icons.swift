...
public enum Asset {
  public static let iconCloseX = ImageAsset(name: "icon-close-x")
  public static let iconClose = ImageAsset(name: "icon-close")
  public static let iconSearch = ImageAsset(name: "icon-search")
  public static let iconTwitter = ImageAsset(name: "icon-twitter")
}
