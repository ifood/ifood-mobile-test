...
extension TweetListViewController {
    private func setupViews() {
        ...
        // emptyAlert label
        emptyAlertLabel.text = "Not found"
    }
}
...
extension TweetListViewController {
    ...
    private func bindViews() {
        ...
        viewModel.username
            .map { LocalizedConstants.Tweets.userHasNotTweetedYet($0) }
            .asDriver(onErrorJustReturn: LocalizedConstants.Tweets.userHasNotTweetedYetDefault)
            .drive(emptyAlertLabel.rx.text)
            .disposed(by: disposeBag)
    ...
    private func bindTableView() {
        ...
        cellsViewModel
            ...
            .drive(onNext: { [weak self] hasNoTweets in
                self?.emptyAlertLabel.isHidden = !hasNoTweets
